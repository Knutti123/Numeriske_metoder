...
int main() 
{
    ...
    ifstream Filip("/home/kristian/Uni/6_semester/Numeriske_metoder/Lektion_2/FilipData.dat");
    for(int i = 0; i < 82; i++) {
        Filip >> yFilip[i];
        Filip >> xFilip[i];
    }
    ...
    ifstream Pont("/home/kristian/Uni/6_semester/Numeriske_metoder/Lektion_2/PontiusData.dat");
    for(int i = 0; i < 40; i++) {
        Pont >> yPont[i];
        Pont >> xPont[i];
    }
